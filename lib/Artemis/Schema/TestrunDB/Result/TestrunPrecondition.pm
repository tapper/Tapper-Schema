package Artemis::Schema::TestrunDB::Result::TestrunPrecondition;
...
__PACKAGE__->belongs_to( precondition  => 'Artemis::Schema::TestrunDB::Result::Precondition', { 'foreign.id' => 'self.precondition_id' });
