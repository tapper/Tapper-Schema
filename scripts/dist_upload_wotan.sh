...
$EXECDIR/../../Artemis/scripts/artemis_version_increment.pl $EXECDIR/../lib/Artemis/Schema.pm
cd $EXECDIR/..
...
ssh artemis@wotan 'echo "/home/artemis/perl510/bin/cpansite install Artemis::Schema" | bash -l'
